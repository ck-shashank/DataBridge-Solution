            ...
            <div className="section-container py-12 lg:py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-sm">
                            Empowering businesses with innovative data solutions and cutting-edge technology to drive growth and digital transformation.
                        </p>
                        ...
                        <div className="flex gap-4 mt-6">
                            {socialLinks.map((social) => (
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="p-2 rounded-xl bg-gray-200 dark:bg-slate-800 text-gray-600 dark:text-gray-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 dark:border-slate-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 text-sm text-gray-600 dark:text-gray-400">
                            <a href="mailto:info@databridge.com" className="flex items-center gap-2 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                ...
                {/* Copyright */}
                <div className="mt-8 pt-8 border-t border-gray-200 dark:border-slate-800 text-center text-sm text-gray-500 dark:text-gray-500">
                    <p>© {currentYear} DataBridge Solutions. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
